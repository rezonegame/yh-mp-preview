/**
 * xiaohu 主题转换脚本 (JavaScript 版本)
 * 运行: node scripts/convert-all-xiaohu.js
 */
...
function convertTheme(xiaohu, filename) {
...
function main() {
    ...
    for (const file of files) {
        try {
            ...
            const xiaohu = JSON.parse(content);
