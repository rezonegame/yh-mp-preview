...
当前测试版本：`3.15.0-beta.1`；稳定版：`3.14.0`。

### 核心能力

- **公众号预览与复制**：在 Obsidian 中实时预览公众号排版效果，一键复制到微信公众号后台。
- **公众号主题画廊**：9 套精选主题按 7 种文章场景归类，另有可找回的历史主题；选择前可试用。
...
3.15 测试版会保留全部 14 个主题 ID、已有主题选择与排版快照。旧主题在画廊的“历史主题”中，不会自动替换；超过三列的表格会给出手机阅读提示，但不会自动改写表格。正式发布前仍需在公众号后台核对粘贴效果。
