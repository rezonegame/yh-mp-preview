  ...
  "src/templates/academic-pro-forest.json"() {
    academic_pro_forest_default = {
      ...
      styles: {
        ...
        accentColor: "#216a52",
        title: {
          h1: { base: "margin: 28px 0 20px; font-size: 1.8em; padding-bottom: 12px; border-bottom: 2px solid #216a52;", content: "font-weight: 700; color: #183f31;", after: "" },
          h2: { base: "margin: 26px 0 12px; padding-left: 12px; border-left: 4px solid #216a52; font-size: 1.38em;", content: "font-weight: 700; color: #183f31;", after: "" },
          h3: { base: "margin: 22px 0 10px; font-size: 1.15em;", content: "font-weight: 700; color: #216a52;", after: "" },
          base: { base: "margin: 18px 0 8px; font-size: 1em;", content: "font-weight: 700; color: #2c5948;", after: "" }
        },
        ...
        code: { header: { container: "margin-bottom: 6px; padding: 6px 10px; background: #e8f1eb;", dot: "display: none;", colors: ["#216a52", "#216a52", "#216a52"] }, block: "margin: 1.2em 0; padding: 14px; background: #f7faf8; border: 1px solid #d9e6dd; color: #243b32;", inline: "padding: 1px 4px; background: #edf5ef; color: #216a52;" },
        image: "border: 1px solid #d9e6dd; border-radius: 4px;",
        link: "color: #216a52; text-decoration: underline;",
        emphasis: { strong: "font-weight: 700; color: #183f31;", em: "color: #476457;", del: "color: #94a3b8;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 2px solid #216a52;", header: "padding: 10px; background: #f3f8f5; color: #183f31; border-bottom: 1px solid #cfe0d4;", cell: "padding: 10px; border-bottom: 1px solid #e1ebe4; color: #334155;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #d9e6dd;",
        footnote: { ref: "color: #216a52;", backref: "color: #216a52;" }
      }
    };
  }
});
  ...
  "src/templates/academic-pro.json"() {
    academic_pro_default = {
      ...
      styles: {
        ...
        accentColor: "#285b92",
        title: {
          h1: { base: "margin: 28px 0 20px; font-size: 1.8em; padding-bottom: 12px; border-bottom: 2px solid #285b92;", content: "font-weight: 700; color: #1d3958;", after: "" },
          h2: { base: "margin: 26px 0 12px; padding-left: 12px; border-left: 4px solid #285b92; font-size: 1.38em;", content: "font-weight: 700; color: #1d3958;", after: "" },
          h3: { base: "margin: 22px 0 10px; font-size: 1.15em;", content: "font-weight: 700; color: #285b92;", after: "" },
          base: { base: "margin: 18px 0 8px; font-size: 1em;", content: "font-weight: 700; color: #385a7b;", after: "" }
        },
        paragraph: "color: #334155;",
        list: { container: "padding-left: 1.45em; color: #334155;", item: "color: #334155;", taskList: "list-style: none; padding-left: 0; color: #334155;" },
        quote: "margin: 1.1em 0; padding: 14px 16px; border-left: 4px solid #285b92; background: #f3f7fb; color: #3f5871;",
        code: { header: { container: "margin-bottom: 6px; padding: 6px 10px; background: #eaf1f8;", dot: "display: none;", colors: ["#285b92", "#285b92", "#285b92"] }, block: "margin: 1.2em 0; padding: 14px; background: #f7f9fc; border: 1px solid #d9e3ef; color: #26384a;", inline: "padding: 1px 4px; background: #edf3f9; color: #285b92;" },
        image: "border: 1px solid #d9e3ef; border-radius: 4px;",
        link: "color: #285b92; text-decoration: underline;",
        emphasis: { strong: "font-weight: 700; color: #1d3958;", em: "color: #536b84;", del: "color: #94a3b8;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 2px solid #285b92;", header: "padding: 10px; background: #f3f7fb; color: #1d3958; border-bottom: 1px solid #cfdeec;", cell: "padding: 10px; border-bottom: 1px solid #e2e8f0; color: #334155;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #d9e3ef;",
        footnote: { ref: "color: #285b92;", backref: "color: #285b92;" }
      }
    };
  }
});
  ...
  "src/templates/apple-product.json"() {
    apple_product_default = {
      ...
      styles: {
        ...
        emphasis: { strong: "font-weight: 700; color: #111827;", em: "color: #4b5563;", del: "color: #9ca3af;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 2px solid #0a84ff;", header: "padding: 10px; background: #f4f8ff; color: #111827; border-bottom: 1px solid #bfdbfe;", cell: "padding: 10px; border-bottom: 1px solid #e5edf8; color: #374151;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #dbeafe;",
        footnote: { ref: "color: #0a84ff;", backref: "color: #0a84ff;" }
      }
    };
  }
});

// src/templates/briefing-grid.json
var briefing_grid_default;
var init_briefing_grid = __esm({
  "src/templates/briefing-grid.json"() {
    briefing_grid_default = {
      id: "briefing-grid",
      name: "\u8F7B\u91CF\u7B80\u62A5",
      ...
      styles: {
        ...
        accentColor: "#355a72",
        title: {
          h1: { base: "margin:28px 0 24px;padding:0 0 10px;border-bottom:1px solid #91adbd;font-size:1.7em;", content: "font-weight:700;color:#223f52;", after: "" },
          h2: { base: "margin:30px 0 13px;padding:8px 10px;background:#edf3f6;border-left:3px solid #355a72;font-size:1.25em;", content: "font-weight:700;color:#223f52;", after: "" },
          h3: { base: "margin:23px 0 9px;padding-bottom:5px;border-bottom:1px dashed #91adbd;font-size:1.08em;", content: "font-weight:700;color:#355a72;", after: "" },
          base: { base: "margin:18px 0 8px;font-size:1em;", content: "font-weight:700;color:#355a72;", after: "" }
        },
        paragraph: "color:#273848;",
        list: { container: "padding-left:1.45em;color:#355a72;", item: "color:#273848;", taskList: "list-style:none;padding-left:0;color:#273848;" },
        quote: "margin:1.1em 0;padding:12px 14px;background:#f3f7f8;border-left:2px solid #91adbd;color:#344d5d;",
        code: { header: { container: "margin-bottom:6px;padding:6px 10px;background:#e9f0f4;", dot: "display:none;", colors: ["#355a72", "#355a72", "#355a72"] }, block: "margin:1.2em 0;padding:14px;background:#f2f6f8;border:1px solid #c9d8e0;color:#273848;", inline: "padding:1px 4px;background:#e9f0f4;color:#294b60;" },
        image: "border:1px solid #c9d8e0;border-radius:2px;",
        link: "color:#294b60;text-decoration:underline;",
        emphasis: { strong: "font-weight:700;color:#223f52;", em: "color:#466173;", del: "color:#677d89;" },
        table: { container: "margin:1.1em 0;border-collapse:collapse;border-top:1px solid #91adbd;", header: "padding:8px;background:#edf3f6;color:#223f52;border-bottom:1px solid #91adbd;", cell: "padding:8px;border-bottom:1px solid #d5e0e5;color:#273848;" },
        hr: "margin:28px 0;border:0;border-top:1px dashed #91adbd;",
        footnote: { ref: "color:#294b60;", backref: "color:#294b60;" }
      }
    };
  }
});

// src/templates/case-file.json
var case_file_default;
  ...
  "src/templates/case-file.json"() {
    case_file_default = {
      ...
      styles: {
        ...
        accentColor: "#40505c",
        title: {
          h1: { base: "margin:26px 0 25px;padding:14px 16px;background:#293a46;font-size:1.65em;", content: "font-weight:700;color:#ffffff;", after: "" },
          h2: { base: "margin:32px 0 14px;padding-bottom:8px;border-bottom:2px solid #40505c;font-size:1.3em;", content: "font-weight:700;color:#293a46;", after: "" },
          h3: { base: "margin:24px 0 10px;padding:7px 10px;background:#eef2f3;font-size:1.08em;", content: "font-weight:700;color:#334651;", after: "" },
          base: { base: "margin:18px 0 8px;font-size:1em;", content: "font-weight:700;color:#40505c;", after: "" }
        },
        paragraph: "color:#2b3740;",
        list: { container: "padding-left:1.45em;color:#40505c;", item: "color:#2b3740;", taskList: "list-style:none;padding-left:0;color:#2b3740;" },
        quote: "margin:1.25em 0;padding:14px 16px;border-left:3px solid #40505c;background:#f2f5f6;color:#354650;",
        code: { header: { container: "margin-bottom:6px;padding:6px 10px;background:#dfe7ea;", dot: "display:none;", colors: ["#40505c", "#40505c", "#40505c"] }, block: "margin:1.2em 0;padding:14px;background:#263742;border-top:4px solid #64828d;color:#eff6f6;", inline: "padding:1px 4px;background:#e9eff1;color:#334651;" },
        image: "padding:4px;border:1px solid #b9c9cf;border-radius:0;",
        link: "color:#334651;text-decoration:underline;",
        emphasis: { strong: "font-weight:700;color:#293a46;", em: "color:#51646e;", del: "color:#6c7d84;" },
        table: { container: "margin:1.2em 0;border-collapse:collapse;border-top:2px solid #40505c;", header: "padding:9px;background:#e9eff1;color:#293a46;border-bottom:1px solid #9fb4bc;", cell: "padding:9px;border-bottom:1px solid #d4e0e3;color:#2b3740;" },
        hr: "margin:30px 0;border:0;border-top:1px solid #9fb4bc;",
        footnote: { ref: "color:#334651;", backref: "color:#334651;" }
      }
    };
  }
});
  ...
  "src/templates/default.json"() {
    default_default = {
      ...
      styles: {
        ...
        emphasis: { strong: "font-weight: 700; color: #1f2937;", em: "color: #475569;", del: "color: #94a3b8;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 2px solid #475569;", header: "padding: 10px; background: #f8fafc; color: #1f2937; border-bottom: 1px solid #dbe3ec;", cell: "padding: 10px; border-bottom: 1px solid #e2e8f0; color: #334155;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #e2e8f0;",
        footnote: { ref: "color: #475569;", backref: "color: #475569;" }
      }
    };
  }
});

// src/templates/eastern-notes.json
var eastern_notes_default;
var init_eastern_notes = __esm({
  "src/templates/eastern-notes.json"() {
    eastern_notes_default = { id: "eastern-notes", name: "\u4E1C\u65B9\u7B3A\u8C31", description: "\u7EB8\u7B3A\u822C\u7684\u6E29\u6DA6\u4F4E\u9971\u548C\u8272\u8C03\uFF0C\u9002\u5408\u6587\u5316\u968F\u7B14\u3001\u8BFB\u4E66\u4E0E\u751F\u6D3B\u8BB0\u5F55\u3002", source: "yh-mp-preview", styles: { container: "background:#ffffff;padding:0;color:#4b4239;", accentColor: "#8a6248", title: { h1: { base: "margin:34px 0 22px;padding-bottom:14px;border-bottom:1px solid #c9b8a5;font-size:1.78em;", content: "font-weight:700;color:#40362e;", after: "" }, h2: { base: "margin:30px 0 14px;padding-left:10px;border-left:3px solid #8a6248;font-size:1.34em;", content: "font-weight:700;color:#5b4435;", after: "" }, h3: { base: "margin:24px 0 10px;font-size:1.13em;", content: "font-weight:700;color:#8a6248;", after: "" }, base: { base: "margin:18px 0 8px;font-size:1em;", content: "font-weight:700;color:#725645;", after: "" } }, paragraph: "color:#4b4239;", list: { container: "padding-left:1.45em;color:#8a6248;", item: "color:#4b4239;", taskList: "list-style:none;padding-left:0;color:#4b4239;" }, quote: "margin:1.3em 0;padding:16px 18px;border-left:3px solid #c9b8a5;background:#fcfaf7;color:#66574b;", code: { header: { container: "display:none;", dot: "display:none;", colors: ["#8a6248", "#8a6248", "#8a6248"] }, block: "margin:1.3em 0;padding:14px;background:#fcfaf7;border:1px solid #e6ddd3;color:#4b4239;", inline: "padding:1px 4px;background:#f6f0e9;color:#725645;" }, image: "border:1px solid #e6ddd3;border-radius:2px;", link: "color:#725645;text-decoration:underline;", emphasis: { strong: "font-weight:700;color:#40362e;", em: "color:#725645;", del: "color:#b8a99a;" }, table: { container: "margin:1.3em 0;border-collapse:collapse;border-top:1px solid #8a6248;", header: "padding:10px;background:#f8f2eb;color:#5b4435;border-bottom:1px solid #dfd1c2;", cell: "padding:10px;border-bottom:1px solid #eee5dc;color:#4b4239;" }, hr: "margin:32px 0;border:0;border-top:1px solid #dfd1c2;", footnote: { ref: "color:#8a6248;", backref: "color:#8a6248;" } } };
  }
});

// src/templates/ink-opinion.json
var ink_opinion_default;
var init_ink_opinion = __esm({
  "src/templates/ink-opinion.json"() {
    ink_opinion_default = {
      id: "ink-opinion",
      name: "\u9ED1\u767D\u9510\u8BC4",
      ...
      styles: {
        ...
        accentColor: "#353535",
        title: {
          h1: { base: "margin:24px 0 28px;padding:0 0 16px;border-bottom:4px solid #202020;font-size:1.95em;", content: "font-weight:800;color:#181818;", after: "" },
          h2: { base: "margin:36px 0 14px;padding-left:12px;border-left:5px solid #202020;font-size:1.3em;", content: "font-weight:800;color:#181818;", after: "" },
          h3: { base: "margin:26px 0 11px;padding-bottom:6px;border-bottom:1px solid #a9a9a9;font-size:1.08em;", content: "font-weight:700;color:#303030;", after: "" },
          base: { base: "margin:20px 0 8px;font-size:1em;", content: "font-weight:700;color:#353535;", after: "" }
        },
        paragraph: "color:#292929;",
        list: { container: "padding-left:1.5em;color:#353535;", item: "color:#292929;", taskList: "list-style:none;padding-left:0;color:#292929;" },
        quote: "margin:1.5em 0;padding:10px 20px;border-top:2px solid #202020;border-bottom:2px solid #202020;color:#303030;",
        code: { header: { container: "margin-bottom:6px;padding:6px 10px;background:#e9e9e9;", dot: "display:none;", colors: ["#353535", "#353535", "#353535"] }, block: "margin:1.2em 0;padding:14px;background:#f4f4f4;border-left:3px solid #353535;color:#292929;", inline: "padding:1px 4px;background:#efefef;color:#292929;" },
        image: "border:1px solid #d2d2d2;border-radius:0;",
        link: "color:#303030;text-decoration:underline;",
        emphasis: { strong: "font-weight:800;color:#181818;", em: "color:#454545;", del: "color:#6d6d6d;" },
        table: { container: "margin:1.3em 0;border-collapse:collapse;border-top:2px solid #202020;", header: "padding:10px;background:#efefef;color:#181818;border-bottom:1px solid #888888;", cell: "padding:10px;border-bottom:1px solid #d2d2d2;color:#292929;" },
        hr: "margin:34px 0;border:0;border-top:2px solid #202020;",
        footnote: { ref: "color:#353535;", backref: "color:#353535;" }
      }
    };
  }
});

// src/templates/knowledge-notes.json
var knowledge_notes_default;
var init_knowledge_notes = __esm({
  "src/templates/knowledge-notes.json"() {
    knowledge_notes_default = {
      id: "knowledge-notes",
      name: "\u7EB8\u9762\u7B14\u8BB0",
      ...
      styles: {
        ...
        accentColor: "#355f59",
        title: {
          h1: { base: "margin:28px 0 22px;padding:0 0 14px;border-bottom:1px solid #b9cec8;font-size:1.72em;", content: "font-weight:700;color:#203a36;", after: "" },
          h2: { base: "margin:30px 0 14px;padding:10px 12px;background:#edf5f2;border-left:3px solid #355f59;font-size:1.28em;", content: "font-weight:700;color:#254b45;", after: "" },
          h3: { base: "margin:24px 0 10px;padding-left:10px;border-left:1px solid #729990;font-size:1.1em;", content: "font-weight:700;color:#355f59;", after: "" },
          base: { base: "margin:18px 0 8px;font-size:1em;", content: "font-weight:700;color:#355f59;", after: "" }
        },
        paragraph: "color:#293c39;",
        list: { container: "padding-left:1.55em;color:#355f59;", item: "color:#293c39;", taskList: "list-style:none;padding-left:0;color:#293c39;" },
        quote: "margin:1.2em 0;padding:14px 16px;background:#f5f8f6;border-left:2px solid #9bb8af;color:#344b45;",
        code: { header: { container: "margin-bottom:6px;padding:6px 10px;background:#eaf1ee;", dot: "display:none;", colors: ["#355f59", "#355f59", "#355f59"] }, block: "margin:1.2em 0;padding:14px;background:#f4f7f5;border:1px solid #d6e2dd;color:#203a36;", inline: "padding:1px 4px;background:#edf3f0;color:#254b45;" },
        image: "padding:4px;border-bottom:1px solid #b9cec8;",
        link: "color:#254b45;text-decoration:underline;",
        emphasis: { strong: "font-weight:700;color:#203a36;", em: "color:#48635b;", del: "color:#677d76;" },
        table: { container: "margin:1.2em 0;border-collapse:collapse;border-top:1px solid #9bb8af;", header: "padding:9px;background:#edf5f2;color:#203a36;border-bottom:1px solid #9bb8af;", cell: "padding:9px;border-bottom:1px solid #d6e2dd;color:#293c39;" },
        hr: "margin:30px 0;border:0;border-top:1px dashed #9bb8af;",
        footnote: { ref: "color:#254b45;", backref: "color:#254b45;" }
      }
    };
  }
});
  ...
  "src/templates/minimal.json"() {
    minimal_default = {
      ...
      styles: {
        ...
        accentColor: "#3f3f46",
        title: {
          h1: { base: "margin: 28px 0 20px; font-size: 1.8em; padding-bottom: 12px; border-bottom: 1px solid #a1a1aa;", content: "font-weight: 700; color: #18181b;", after: "" },
          h2: { base: "margin: 26px 0 12px; font-size: 1.38em;", content: "font-weight: 700; color: #18181b;", after: "" },
          h3: { base: "margin: 22px 0 10px; font-size: 1.15em;", content: "font-weight: 700; color: #3f3f46;", after: "" },
          base: { base: "margin: 18px 0 8px; font-size: 1em;", content: "font-weight: 700; color: #52525b;", after: "" }
        },
        paragraph: "color: #3f3f46;",
        list: { container: "padding-left: 1.45em; color: #3f3f46;", item: "color: #3f3f46;", taskList: "list-style: none; padding-left: 0; color: #3f3f46;" },
        quote: "margin: 1.1em 0; padding: 14px 16px; border-left: 3px solid #71717a; background: #fafafa; color: #52525b;",
        code: { header: { container: "display: none;", dot: "display: none;", colors: ["#52525b", "#52525b", "#52525b"] }, block: "margin: 1.2em 0; padding: 14px; background: #fafafa; border: 1px solid #e4e4e7; color: #27272a;", inline: "padding: 1px 4px; background: #f4f4f5; color: #3f3f46;" },
        image: "border: 0; border-radius: 0;",
        link: "color: #27272a; text-decoration: underline;",
        emphasis: { strong: "font-weight: 700; color: #18181b;", em: "color: #52525b;", del: "color: #a1a1aa;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 1px solid #71717a;", header: "padding: 10px; color: #18181b; border-bottom: 1px solid #d4d4d8;", cell: "padding: 10px; border-bottom: 1px solid #e4e4e7; color: #3f3f46;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #d4d4d8;",
        footnote: { ref: "color: #52525b;", backref: "color: #52525b;" }
      }
    };
  }
});
  ...
  "src/templates/modern-report.json"() {
    modern_report_default = {
      ...
      styles: {
        ...
        accentColor: "#252b36",
        title: {
          h1: { base: "margin: 28px 0 20px; font-size: 1.8em; padding-bottom: 12px; border-bottom: 3px solid #252b36;", content: "font-weight: 700; color: #17191d;", after: "" },
          h2: { base: "margin: 26px 0 12px; padding: 8px 12px; border-left: 4px solid #252b36; background: #f4f5f7; font-size: 1.35em;", content: "font-weight: 700; color: #17191d;", after: "" },
          h3: { base: "margin: 22px 0 10px; font-size: 1.15em;", content: "font-weight: 700; color: #30343b;", after: "" },
          base: { base: "margin: 18px 0 8px; font-size: 1em;", content: "font-weight: 700; color: #30343b;", after: "" }
        },
        paragraph: "color: #30343b;",
        list: { container: "padding-left: 1.45em; color: #30343b;", item: "color: #30343b;", taskList: "list-style: none; padding-left: 0; color: #30343b;" },
        quote: "margin: 1.1em 0; padding: 14px 16px; border-left: 4px solid #252b36; background: #f7f7f8; color: #4b5563;",
        code: { header: { container: "margin-bottom: 6px; padding: 6px 10px; background: #e9ebef;", dot: "display: none;", colors: ["#252b36", "#252b36", "#252b36"] }, block: "margin: 1.2em 0; padding: 14px; background: #f4f5f7; border: 1px solid #d9dde4; color: #252b36;", inline: "padding: 1px 4px; background: #eceef1; color: #252b36;" },
        image: "border: 1px solid #d9dde4; border-radius: 2px;",
        link: "color: #252b36; text-decoration: underline;",
        emphasis: { strong: "font-weight: 700; color: #17191d;", em: "color: #4b5563;", del: "color: #9ca3af;" },
        table: { container: "margin: 1.2em 0; border-collapse: collapse; border-top: 2px solid #252b36;", header: "padding: 10px; background: #252b36; color: #ffffff; border-bottom: 1px solid #252b36;", cell: "padding: 10px; border-bottom: 1px solid #d9dde4; color: #30343b;" },
        hr: "margin: 28px 0; border: 0; border-top: 1px solid #d9dde4;",
        footnote: { ref: "color: #252b36;", backref: "color: #252b36;" }
      }
    };
  }
});
  ...
  "src/templates/zen-essence.json"() {
    zen_essence_default = {
      ...
      styles: {
        ...
        emphasis: { strong: "font-weight: 700; color: #3f463d;", em: "color: #687065;", del: "color: #aeb7a7;" },
        table: { container: "margin: 1.3em 0; border-collapse: collapse; border-top: 1px solid #aeb7a7;", header: "padding: 10px; color: #4e584a; border-bottom: 1px solid #dce1d7;", cell: "padding: 10px; border-bottom: 1px solid #e7ebe3; color: #5d625d;" },
        hr: "margin: 32px 0; border: 0; border-top: 1px solid #dce1d7;",
        footnote: { ref: "color: #79836f;", backref: "color: #79836f;" }
      }
    };
  }
});

// src/templates/warm-paper.json
var warm_paper_default;
var init_warm_paper = __esm({
  "src/templates/warm-paper.json"() {
    warm_paper_default = {
      id: "warm-paper",
      name: "\u6696\u7EB8\u6563\u6587",
      ...
      styles: {
        ...
        accentColor: "#805c46",
        title: {
          h1: { base: "margin:34px 0 26px;padding:0 0 12px;border-bottom:1px solid #d9c5ae;font-size:1.78em;", content: "font-weight:600;color:#47372b;", after: "" },
          h2: { base: "margin:38px 0 16px;padding-left:10px;border-left:2px solid #a17a57;font-size:1.28em;", content: "font-weight:600;color:#47372b;", after: "" },
          h3: { base: "margin:28px 0 12px;font-size:1.1em;", content: "font-weight:600;color:#6b4b37;", after: "" },
          base: { base: "margin:22px 0 9px;font-size:1em;", content: "font-weight:600;color:#6b4b37;", after: "" }
        },
        paragraph: "color:#3a332c;",
        list: { container: "padding-left:1.45em;color:#805c46;", item: "color:#3a332c;", taskList: "list-style:none;padding-left:0;color:#3a332c;" },
        ...
        code: { header: { container: "margin-bottom:6px;padding:6px 10px;background:#f2ebe2;", dot: "display:none;", colors: ["#805c46", "#805c46", "#805c46"] }, block: "margin:1.2em 0;padding:14px;background:#faf6f0;border:1px solid #e2d4c3;color:#3a332c;", inline: "padding:1px 4px;background:#f5ece1;color:#614632;" },
        image: "padding:5px;border:1px solid #e2d4c3;",
        link: "color:#614632;text-decoration:underline;",
        emphasis: { strong: "font-weight:700;color:#47372b;", em: "color:#6b4b37;", del: "color:#77685b;" },
        table: { container: "margin:1.3em 0;border-collapse:collapse;border-top:1px solid #c8aa8d;", header: "padding:10px;background:#fbf6ef;color:#47372b;border-bottom:1px solid #c8aa8d;", cell: "padding:10px;border-bottom:1px solid #e2d4c3;color:#3a332c;" },
        hr: "margin:38px 0;border:0;border-top:1px solid #d9c5ae;",
        footnote: { ref: "color:#614632;", backref: "color:#614632;" }
      }
    };
  }
});
...
var init_templates = __esm({
  "src/templates/index.ts"() {
    ...
    init_olive_journal();
    init_product_review();
    init_red_white_editorial();
    init_zen_essence();
    init_warm_paper();
    templates = {
      default: default_default,
      "deep-reading": deep_reading_default,
      "academic-pro": academic_pro_default,
      "clear-guide": clear_guide_default,
      "knowledge-notes": knowledge_notes_default,
      "apple-product": apple_product_default,
      "product-review": product_review_default,
      minimal: minimal_default,
      "red-white-editorial": red_white_editorial_default,
      "ink-opinion": ink_opinion_default,
      "modern-report": modern_report_default,
      "data-blueprint": data_blueprint_default,
      "briefing-grid": briefing_grid_default,
      "zen-essence": zen_essence_default,
      "warm-paper": warm_paper_default,
      "eastern-notes": eastern_notes_default,
      "academic-pro-forest": academic_pro_forest_default,
      "olive-journal": olive_journal_default,
      "case-file": case_file_default
    };
  }
});
...
var MPConverter = class {
  ...
  static processElements(container, enableImageCaptions = true) {
    ...
    container.querySelectorAll(".callout").forEach((callout) => {
      ...
      const calloutType = ((_a = calloutEl.getAttribute("data-callout")) == null ? void 0 : _a.toLowerCase()) || "note";
      const calloutConfig = {
        "tip": { color: "#4caf50", icon: "\u{1F4A1}" },
        "hint": { color: "#4caf50", icon: "\u{1F4A1}" },
        "note": { color: "#448aff", icon: "\u{1F4DD}" },
        "info": { color: "#448aff", icon: "\u2139\uFE0F" },
        "warning": { color: "#ff9800", icon: "\u26A0\uFE0F" },
        "caution": { color: "#f44336", icon: "\u{1F534}" },
        "danger": { color: "#f44336", icon: "\u2757" },
        "important": { color: "#e040fb", icon: "\u2757" },
        "example": { color: "#7c4dff", icon: "\u{1F4CB}" },
        "quote": { color: "#9e9e9e", icon: "\u{1F4AC}" },
        "abstract": { color: "#00bcd4", icon: "\u{1F4D1}" },
        "summary": { color: "#00bcd4", icon: "\u{1F4D1}" },
      ...
      const contentHtml = (contentEl == null ? void 0 : contentEl.innerHTML) || "";
      ...
      (_b = calloutEl.parentNode) == null ? void 0 : _b.replaceChild(calloutDiv, calloutEl);
    });
    ...
    container.querySelectorAll("span.internal-embed[src]").forEach(async (el) => {
      ...
      try {
        ...
        if (file) {
          ...
          (_a = originalSpan.parentNode) == null ? void 0 : _a.replaceChild(figure, originalSpan);
        }
      } catch (error) {
    ...
    const footnotesMap = /* @__PURE__ */ new Map();
    ...
    if (footnoteRefs.length > 0 && footnotesMap.size > 0) {
      footnoteRefs.forEach((ref, index) => {
        ...
        ref.style.color = "var(--text-accent)";
...
var ANS_CJK_AFTER = `${A}\u0370-\u03FF0-9@\\$%\\^&\\*\\-\\+\\\\=\xA1-\xFF\u2150-\u218F\u2700\u2014\u27BF`;
var ANS_BEFORE_CJK = `${A}\u0370-\u03FF0-9\\$%\\^&\\*\\-\\+\\\\=\xA1-\xFF\u2150-\u218F\u2700\u2014\u27BF`;
...
__publicField2(DomWalker, "blockTags", /^(div|p|h1|h2|h3|h4|h5|h6)$/i);
__publicField2(DomWalker, "ignoredTags", /^(code|pre|script|style|textarea|iframe|input)$/i);
__publicField2(DomWalker, "presentationalTags", /^(b|code|del|em|i|s|strong|kbd)$/i);
__publicField2(DomWalker, "spaceLikeTags", /^(br|hr|i|img|pangu)$/i);
__publicField2(DomWalker, "spaceSensitiveTags", /^(a|del|pre|s|strike|u)$/i);
__publicField2(DomWalker, "ignoredClass", "no-pangu-spacing");
var TaskQueue = class {
  constructor() {
    __publicField2(this, "queue", []);
    __publicField2(this, "isProcessing", false);
    __publicField2(this, "onComplete");
  }
  add(task) {
...
var TaskScheduler = class {
  constructor() {
    ...
    __publicField2(this, "taskQueue", new TaskQueue());
  }
  get queue() {
...
var BrowserPangu = class extends Pangu {
  constructor() {
    super(...arguments);
    __publicField2(this, "isAutoSpacingPageExecuted", false);
    __publicField2(this, "autoSpacingPageObserver", null);
    __publicField2(this, "taskScheduler", new TaskScheduler());
    __publicField2(this, "visibilityDetector", new VisibilityDetector());
  }
  // PUBLIC
  ...
  static async copyToClipboard(element, options = {}) {
    try {
      ...
      try {
        ...
        pangu2.spacingElement(tempDiv);
        const walker = document.createTreeWalker(tempDiv, NodeFilter.SHOW_TEXT);
        let node;
        while (node = walker.nextNode()) {
          if (node.nodeValue) {
            node.nodeValue = node.nodeValue.replace(/「/g, "\u201C").replace(/」/g, "\u201D").replace(/『/g, "\u2018").replace(/』/g, "\u2019");
          }
        }
...
var ThemeGalleryModal = class extends import_obsidian2.Modal {
  ...
  onOpen() {
    ...
    (0, import_obsidian2.setIcon)(this.historyButton, "archive");
  ...
  async onOpen() {
    ...
    if (settings.templateId) {
      ...
      if (templateId.startsWith("minimal-"))
        targetSeries = "Minimal \u7CFB\u5217";
      else if (templateId.startsWith("focus-"))
        targetSeries = "Focus \u7CFB\u5217";
      else if (templateId.startsWith("elegant-"))
        targetSeries = "Elegant \u7CFB\u5217";
      else if (templateId.startsWith("bold-"))
        targetSeries = "Bold \u7CFB\u5217";
  ...
  async loadSettings() {
    ...
    if (!savedData.backgrounds || !Array.isArray(savedData.backgrounds) || savedData.backgrounds.length === 0) {
      ...
      savedData.backgrounds.forEach((b) => {
        if (b && b.id)
          savedBackgroundsMap.set(b.id, b);
      });
...
var NoteThemeGalleryModal = class extends import_obsidian11.Modal {
  ...
  renderGallery() {
    if (!this.gridContainer)
      return;
    this.gridContainer.empty();
    this.gridContainer.createEl("h3", { cls: "mp-gallery-section-title", text: "\u7B14\u8BB0\u9605\u8BFB\u4E3B\u9898 \xB7 3 \u4E2A\u4E3B\u9898" });
    const cardGrid = this.gridContainer.createDiv("mp-gallery-card-grid");
    NOTE_THEME_ENTRIES.forEach((entry) => {
      ...
      if (selected) {
        const check = info.createDiv("mp-theme-checkmark");
        (0, import_obsidian11.setIcon)(check, "check");
      }
      card.addEventListener("click", () => {
...
// src/settings/MPSettingTab.ts
var MPSettingTab = class extends import_obsidian12.PluginSettingTab {
  ...
  createSection(containerEl, title, renderContent) {
    ...
    (0, import_obsidian12.setIcon)(toggle, "chevron-right");
    ...
    header.addEventListener("click", () => {
      const isExpanded = !section.hasClass("is-expanded");
      section.toggleClass("is-expanded", isExpanded);
      (0, import_obsidian12.setIcon)(toggle, isExpanded ? "chevron-down" : "chevron-right");
      if (isExpanded) {
    ...
    if (this.expandedSections.has(title) || !containerEl.querySelector(".settings-section")) {
      ...
      (0, import_obsidian12.setIcon)(toggle, "chevron-down");
      this.expandedSections.add(title);
    }
    return section;
  }
  ...
  renderBasicSettings(containerEl) {
    ...
    (0, import_obsidian12.setIcon)(fontToggle, "chevron-right");
    ...
    fontHeader.addEventListener("click", () => {
      ...
      (0, import_obsidian12.setIcon)(fontToggle, isExpanded ? "chevron-down" : "chevron-right");
    });
    ...
    this.plugin.settingsManager.getFontOptions().forEach((font) => {
      ...
      const setting = new import_obsidian12.Setting(fontItem).setName(font.label).setDesc(font.value);
      if (!font.isPreset) {
        setting.addExtraButton((btn) => btn.setIcon("pencil").setTooltip("\u7F16\u8F91").onClick(() => {
          new CreateFontModal(
            ...
            async (updatedFont) => {
              ...
              this.display();
              new import_obsidian12.Notice("\u8BF7\u91CD\u542F Obsidian \u6216\u91CD\u65B0\u52A0\u8F7D\u4EE5\u4F7F\u66F4\u6539\u751F\u6548");
            },
            font
          ).open();
    ...
    new import_obsidian12.Setting(fontContent).addButton((btn) => btn.setButtonText("+ \u6DFB\u52A0\u5B57\u4F53").setCta().onClick(() => {
      new CreateFontModal(
        this.app,
        async (newFont) => {
  ...
  renderTemplateSettings(containerEl) {
    ...
    (0, import_obsidian12.setIcon)(templateVisibilityToggle, "chevron-right");
    ...
    templateVisibilityHeader.addEventListener("click", () => {
      ...
      (0, import_obsidian12.setIcon)(templateVisibilityToggle, isExpanded ? "chevron-down" : "chevron-right");
    });
    ...
    this.plugin.settingsManager.getAllTemplates().filter((template) => !template.isPreset).forEach((template) => {
      ...
      new import_obsidian12.Setting(templateItem).setName(template.name).setDesc(template.description).addExtraButton((btn) => btn.setIcon("eye").setTooltip("\u9884\u89C8").onClick(() => {
        ...
        try {
          ...
          new import_obsidian12.Notice("ThemeManifest \u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F\u3002");
        } catch (_) {
          new import_obsidian12.Notice("\u65E0\u6CD5\u5199\u5165\u526A\u8D34\u677F\uFF0C\u8BF7\u68C0\u67E5 Obsidian \u7684\u7CFB\u7EDF\u6743\u9650\u3002");
        }
    ...
    new import_obsidian12.Setting(containerEl).setName("\u4E3B\u9898\u5DE5\u4F5C\u5BA4\uFF08V3\uFF09").setDesc("ThemeManifest \u53EA\u4F1A\u5BFC\u5165\u4E3A\u81EA\u5B9A\u4E49\u4E3B\u9898\uFF1B\u7248\u672C\u3001\u8BB8\u53EF\u8BC1\u548C\u7EC4\u4EF6\u7ED3\u6784\u4F1A\u5148\u6821\u9A8C\u3002\u81EA\u5B9A\u4E49\u4E3B\u9898\u53F3\u4FA7\u7684\u590D\u5236\u6309\u94AE\u53EF\u5BFC\u51FA\u3002").addButton((btn) => btn.setButtonText("\u4ECE JSON \u5BFC\u5165").onClick(() => {
      new ThemeManifestImportModal(this.app, async (manifest) => {
        if (this.plugin.settingsManager.getTemplate(manifest.id)) {
          new import_obsidian12.Notice(`\u4E3B\u9898 ID \u201C${manifest.id}\u201D \u5DF2\u5B58\u5728\uFF0C\u8BF7\u5728 JSON \u4E2D\u6539\u7528\u65B0\u7684 id\u3002`);
          return;
        }
        const baseTemplate = this.plugin.settingsManager.getTemplate("default");
        if (!baseTemplate) {
          new import_obsidian12.Notice("\u627E\u4E0D\u5230\u9ED8\u8BA4\u4E3B\u9898\uFF0C\u65E0\u6CD5\u5B8C\u6210\u5BFC\u5165\u3002");
          return;
        }
        ...
        this.display();
        new import_obsidian12.Notice(`\u5DF2\u5BFC\u5165\u4E3B\u9898\uFF1A${manifest.name}`);
      }).open();
    }));
    new import_obsidian12.Setting(containerEl).addButton((btn) => btn.setButtonText("+ \u65B0\u5EFA\u6A21\u677F").setCta().onClick(() => {
      new CreateTemplateModal(
        this.app,
        this.plugin,
        async (newTemplate) => {
  ...
  renderBackgroundSettings(containerEl) {
    ...
    (0, import_obsidian12.setIcon)(backgroundVisibilityToggle, "chevron-right");
    ...
    backgroundVisibilityHeader.addEventListener("click", () => {
      ...
      (0, import_obsidian12.setIcon)(backgroundVisibilityToggle, isExpanded ? "chevron-down" : "chevron-right");
    });
    ...
    addButton.addEventListener("click", async () => {
      ...
      renderBackgroundLists();
      new import_obsidian12.Notice("\u80CC\u666F\u663E\u793A\u8BBE\u7F6E\u5DF2\u66F4\u65B0");
    });
    removeButton.addEventListener("click", async () => {
      ...
      renderBackgroundLists();
      new import_obsidian12.Notice("\u80CC\u666F\u663E\u793A\u5DF2\u66F4\u65B0");
    });
    ...
    this.plugin.settingsManager.getAllBackgrounds().filter((background) => !background.isPreset).forEach((background) => {
      ...
      new import_obsidian12.Setting(backgroundItem).setName(background.name).addExtraButton((btn) => btn.setIcon("pencil").setTooltip("\u7F16\u8F91").onClick(() => {
        new CreateBackgroundModal(
          ...
          async (updatedBackground) => {
            ...
            this.display();
            new import_obsidian12.Notice("\u80CC\u666F\u5DF2\u66F4\u65B0");
          },
          background
        ).open();
      })).addExtraButton((btn) => btn.setIcon("trash").setTooltip("\u5220\u9664").onClick(() => {
        new ConfirmModal(
          ...
          async () => {
            ...
            this.display();
            new import_obsidian12.Notice("\u80CC\u666F\u5DF2\u5220\u9664");
          }
        ).open();
      }));
    ...
    new import_obsidian12.Setting(containerEl).addButton((btn) => btn.setButtonText("+ \u65B0\u5EFA\u80CC\u666F").setCta().onClick(() => {
      new CreateBackgroundModal(
        this.app,
        async (newBackground) => {
          await this.plugin.settingsManager.addCustomBackground(newBackground);
          this.display();
          new import_obsidian12.Notice("\u80CC\u666F\u5DF2\u521B\u5EFA");
        }
      ).open();
    }));
  }
  ...
  renderLayoutEnhancementSettings(containerEl) {
    ...
    new import_obsidian12.Setting(containerEl).setName("\u81EA\u52A8\u9605\u8BFB\u5BFC\u822A").setDesc("\u5F53\u6587\u7AE0 h2/h3 \u6570\u91CF\u8FBE\u5230\u9608\u503C\u65F6\uFF0C\u81EA\u52A8\u5728\u5F00\u5934\u63D2\u5165\u76EE\u5F55\u5361\u7247").addToggle((toggle) => toggle.setValue(layout.enableAutoToc).onChange(async (value) => {
    ...
    new import_obsidian12.Setting(containerEl).setName("\u76EE\u5F55\u89E6\u53D1\u9608\u503C").setDesc("h2/h3 \u6570\u91CF\u8FBE\u5230\u8BE5\u503C\u624D\u81EA\u52A8\u751F\u6210\u9605\u8BFB\u5BFC\u822A").addText((text) => text.setPlaceholder("3").setValue(String(layout.tocMinHeadings || 3)).onChange(async (value) => {
    ...
    new import_obsidian12.Setting(containerEl).setName("\u4EFB\u52A1\u5217\u8868\u589E\u5F3A").setDesc("\u5C06 Markdown \u4EFB\u52A1\u5217\u8868\u8F6C\u6362\u4E3A\u516C\u4F17\u53F7\u68C0\u67E5\u6E05\u5355\u5361\u7247").addToggle((toggle) => toggle.setValue(layout.enableTaskListEnhancement).onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({
        layoutEnhancements: {
          ...this.plugin.settingsManager.getSettings().layoutEnhancements,
    ...
    new import_obsidian12.Setting(containerEl).setName("\u56FE\u7247 Alt \u56FE\u6CE8").setDesc("\u628A\u56FE\u7247 alt \u6587\u672C\u663E\u793A\u4E3A\u56FE\u6CE8").addToggle((toggle) => toggle.setValue(layout.enableImageCaptions).onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({
        layoutEnhancements: {
          ...this.plugin.settingsManager.getSettings().layoutEnhancements,
    ...
    new import_obsidian12.Setting(containerEl).setName("\u8868\u683C\u6A2A\u5411\u4F18\u5316").setDesc("\u4E3A\u8868\u683C\u589E\u52A0\u79FB\u52A8\u7AEF\u6A2A\u5411\u6EDA\u52A8\u5BB9\u5668\uFF0C\u907F\u514D\u7A84\u5C4F\u6EA2\u51FA").addToggle((toggle) => toggle.setValue(layout.enableTableEnhancement).onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({
        layoutEnhancements: {
          ...this.plugin.settingsManager.getSettings().layoutEnhancements,
    ...
    new import_obsidian12.Setting(containerEl).setName("\u81EA\u52A8\u63D2\u5165\u4F5C\u8005\u5361").setDesc("\u5728\u6587\u7AE0\u672B\u5C3E\u81EA\u52A8\u63D2\u5165\u4F5C\u8005\u4FE1\u606F\u5361").addToggle((toggle) => toggle.setValue(layout.enableAuthorCard).onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({
        layoutEnhancements: {
          ...this.plugin.settingsManager.getSettings().layoutEnhancements,
    ...
    new import_obsidian12.Setting(containerEl).setName("\u81EA\u52A8\u63D2\u5165\u5173\u6CE8\u5F15\u5BFC").setDesc("\u5728\u6587\u7AE0\u672B\u5C3E\u81EA\u52A8\u63D2\u5165\u5173\u6CE8/\u6536\u85CF\u5F15\u5BFC\u5361").addToggle((toggle) => toggle.setValue(layout.enableSubscribeCard).onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({
        layoutEnhancements: {
          ...this.plugin.settingsManager.getSettings().layoutEnhancements,
  ...
  addAuthorTextSetting(containerEl, name, key, multiline = false) {
    ...
    const setting = new import_obsidian12.Setting(containerEl).setName(name);
    if (multiline) {
  ...
  renderAdvancedSettings(containerEl) {
    new import_obsidian12.Setting(containerEl).setName("\u81EA\u5B9A\u4E49\u5934\u90E8 (HTML)").setDesc("\u5728\u6587\u7AE0\u9876\u90E8\u63D2\u5165\u7684 HTML \u4EE3\u7801\uFF08\u5982\u5173\u6CE8\u5F15\u5BFC\uFF09").addTextArea((text) => text.setPlaceholder("<div>...</div>").setValue(this.plugin.settingsManager.getSettings().customHeader || "").onChange(async (value) => {
      await this.plugin.settingsManager.updateSettings({ customHeader: value });
    }));
    new import_obsidian12.Setting(containerEl).setName("\u81EA\u5B9A\u4E49\u5C3E\u90E8 (HTML)").setDesc("\u5728\u6587\u7AE0\u5E95\u90E8\u63D2\u5165\u7684 HTML \u4EE3\u7801\uFF08\u5982\u4E8C\u7EF4\u7801\uFF09").addTextArea((text) => text.setPlaceholder("<div>...</div>").setValue(this.plugin.settingsManager.getSettings().customFooter || "").onChange(async (value) => {
  ...
  renderNoteLayoutSettings(containerEl) {
    ...
    new import_obsidian12.Setting(containerEl).setName("\u542F\u7528\u7B14\u8BB0\u6392\u7248\u589E\u5F3A").setDesc(unavailable ? "\u8BBE\u7F6E\u6587\u4EF6\u4E0D\u53EF\u7528\uFF0C\u5DF2\u6682\u505C\u7B14\u8BB0\u6392\u7248\u589E\u5F3A" : "\u81EA\u52A8\u6539\u5584 Obsidian \u9605\u8BFB\u89C6\u56FE\u548C\u5B9E\u65F6\u9884\u89C8\uFF0C\u4E0D\u4FEE\u6539 Markdown \u5185\u5BB9").addToggle((toggle) => toggle.setValue(settings.enabled).setDisabled(unavailable).onChange(async (value) => {
      try {
        await enhancement.setEnabled(value);
        new import_obsidian12.Notice(value ? "\u7B14\u8BB0\u6392\u7248\u589E\u5F3A\u5DF2\u5F00\u542F" : "\u7B14\u8BB0\u6392\u7248\u589E\u5F3A\u5DF2\u5173\u95ED");
      } catch (error) {
        toggle.setValue(false);
        new import_obsidian12.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u4FDD\u5B58\u5931\u8D25");
      }
    }));
    new import_obsidian12.Setting(containerEl).setName("\u6E90\u7801\u6A21\u5F0F\u663E\u793A\u589E\u5F3A").setDesc("\u4E3A\u5B9E\u65F6\u9884\u89C8\u548C\u6E90\u7801\u7F16\u8F91\u589E\u52A0\u6807\u9898\u3001\u5217\u8868\u3001\u5F15\u7528\u548C\u4EE3\u7801\u6807\u8BB0\u7684\u53EF\u8BFB\u6027\u6837\u5F0F\uFF0C\u4E0D\u4FEE\u6539\u5185\u5BB9").addToggle((toggle) => toggle.setValue(settings.sourceModeEnabled).setDisabled(unavailable).onChange(async (value) => {
      try {
        await store.updateSettings({ sourceModeEnabled: value });
        enhancement.refresh();
      } catch (error) {
        toggle.setValue(!value);
        new import_obsidian12.Notice(error instanceof Error ? error.message : "\u6E90\u7801\u6A21\u5F0F\u8BBE\u7F6E\u4FDD\u5B58\u5931\u8D25");
      }
    }));
    new import_obsidian12.Setting(containerEl).setName("\u4E3B\u9898\u753B\u5ECA").setDesc("\u5728\u7B14\u8BB0\u9605\u8BFB\u548C\u516C\u4F17\u53F7\u4E24\u4E2A\u573A\u666F\u4E2D\u5206\u522B\u9009\u62E9\u4E3B\u9898\uFF1B\u5F53\u524D\u7B14\u8BB0\u652F\u6301\u8BD5\u7528\u548C\u72EC\u7ACB\u5E94\u7528").addButton((button) => button.setButtonText("\u6253\u5F00\u7B14\u8BB0\u4E3B\u9898\u753B\u5ECA").onClick(() => new NoteThemeGalleryModal(this.app, store, enhancement).open()));
    const updateDefaults = async (patch) => {
      const latest = store.getSettings();
      await store.updateSettings({ defaults: { ...latest.defaults, ...patch } });
      enhancement.refresh();
    };
    new import_obsidian12.Setting(containerEl).setName("\u7B14\u8BB0\u9605\u8BFB\u4E3B\u9898").setDesc("\u9996\u6279\u652F\u6301\u9ED8\u8BA4\u3001\u6DF1\u5EA6\u9605\u8BFB\u548C\u6781\u7B80\u4E09\u5957 Obsidian \u9605\u8BFB\u4E3B\u9898").addDropdown((dropdown) => dropdown.addOption("default", "\u9ED8\u8BA4").addOption("deep-reading", "\u6DF1\u5EA6\u9605\u8BFB").addOption("minimal", "\u6781\u7B80").setValue(settings.defaults.themeId).setDisabled(unavailable).onChange((value) => updateDefaults({ themeId: value })));
    new import_obsidian12.Setting(containerEl).setName("\u7B14\u8BB0\u5B57\u53F7").setDesc("\u8303\u56F4 14\u201324px").addText((text) => text.setValue(String(settings.defaults.fontSize)).setDisabled(unavailable).onChange((value) => updateDefaults({ fontSize: Number(value) })));
    new import_obsidian12.Setting(containerEl).setName("\u7B14\u8BB0\u884C\u9AD8").setDesc("\u8303\u56F4 1.4\u20132.2").addText((text) => text.setValue(String(settings.defaults.lineHeight)).setDisabled(unavailable).onChange((value) => updateDefaults({ lineHeight: Number(value) })));
    new import_obsidian12.Setting(containerEl).setName("\u7B14\u8BB0\u6700\u5927\u5BBD\u5EA6").setDesc("\u8303\u56F4 560\u2013960px").addText((text) => text.setValue(String(settings.defaults.maxWidth)).setDisabled(unavailable).onChange((value) => updateDefaults({ maxWidth: Number(value) })));
    new import_obsidian12.Setting(containerEl).setName("\u5907\u4EFD\u5F53\u524D\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E").setDesc("\u5199\u5165\u72EC\u7ACB\u7684 note-layout.json \u4E4B\u524D\u4FDD\u7559\u53EF\u6062\u590D\u526F\u672C").addButton((button) => button.setButtonText("\u521B\u5EFA\u5907\u4EFD").onClick(async () => {
      try {
        const backup = await store.createBackup("manual");
        new import_obsidian12.Notice(backup ? "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u5907\u4EFD\u5DF2\u521B\u5EFA" : "\u5F53\u524D\u8FD8\u6CA1\u6709\u53EF\u5907\u4EFD\u7684\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E");
      } catch (error) {
        new import_obsidian12.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u5907\u4EFD\u5931\u8D25");
      }
    }));
    new import_obsidian12.Setting(containerEl).setName("\u6062\u590D\u6700\u8FD1\u5907\u4EFD").setDesc("\u6062\u590D\u524D\u4F1A\u81EA\u52A8\u4FDD\u7559\u5F53\u524D\u8BBE\u7F6E").addButton((button) => button.setButtonText("\u6062\u590D").onClick(async () => {
      try {
        const backup = await store.restoreLatestBackup();
        new import_obsidian12.Notice(backup ? "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u5DF2\u6062\u590D" : "\u6CA1\u6709\u53EF\u6062\u590D\u7684\u7B14\u8BB0\u6392\u7248\u5907\u4EFD");
      } catch (error) {
        new import_obsidian12.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u6062\u590D\u5931\u8D25");
      }
    }));
  }
};
...
var NoteLayoutStore = class {
  constructor(adapter, pluginDir) {
    ...
    this.loaded = false;
    this.available = true;
    const directory = (0, import_obsidian13.normalizePath)(pluginDir || ".obsidian/plugins/yh-mp-preview");
    this.filePath = (0, import_obsidian13.normalizePath)(`${directory}/${NOTE_LAYOUT_FILE_NAME}`);
    this.backupDir = (0, import_obsidian13.normalizePath)(`${directory}/${NOTE_LAYOUT_BACKUP_DIR}`);
  }
  async load() {
    this.loaded = true;
    this.available = true;
...
`;
  ...
  async createBackupFromRaw(raw, reason) {
    ...
    const path = (0, import_obsidian13.normalizePath)(`${this.backupDir}/${name}`);
...
var NoteLayoutEnhancement = class {
  constructor(plugin, app, store) {
    ...
    this.previewProfiles = /* @__PURE__ */ new Map();
  }
  load() {
    if (this.loaded)
      return;
  ...
  setPreviewProfile(path, profile) {
    if (!this.loaded)
      return;
    this.previewProfiles.set(path, profile);
    this.refresh();
  }
  clearPreviewProfile(path) {
    if (!this.previewProfiles.delete(path))
      return;
    this.refresh();
  }
  unload() {
  ...
  createEditorExtension() {
    ...
    const getProfile = (path) => this.getProfileForPath(path);
    return import_view.ViewPlugin.fromClass(class {
      ...
      apply() {
        const info = this.view.state.field(import_obsidian14.editorInfoField, false);
  ...
  getProfileForPath(path) {
    if (!this.enabled)
      return null;
    if (this.previewProfiles.has(path))
      return this.previewProfiles.get(path) || null;
...
// src/main.ts
var MPPlugin = class extends import_obsidian15.Plugin {
  async onload() {
    ...
    try {
      ...
      new import_obsidian15.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u8BFB\u53D6\u5931\u8D25\uFF0C\u5DF2\u7981\u7528\u7B14\u8BB0\u6392\u7248\u589E\u5F3A");
    }
    ...
    this.addCommand({
      ...
      callback: async () => {
        try {
          ...
          new import_obsidian15.Notice(enabled ? "\u7B14\u8BB0\u6392\u7248\u589E\u5F3A\u5DF2\u5F00\u542F" : "\u7B14\u8BB0\u6392\u7248\u589E\u5F3A\u5DF2\u5173\u95ED");
        } catch (error) {
          new import_obsidian15.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u8BBE\u7F6E\u4FDD\u5B58\u5931\u8D25");
        }
      }
    });
    this.addCommand({
      ...
      callback: async () => {
        try {
          ...
          new import_obsidian15.Notice(backup ? `\u5DF2\u6062\u590D\u7B14\u8BB0\u6392\u7248\u5907\u4EFD\uFF1A${backup.createdAt}` : "\u6CA1\u6709\u53EF\u6062\u590D\u7684\u7B14\u8BB0\u6392\u7248\u5907\u4EFD");
        } catch (error) {
          new import_obsidian15.Notice(error instanceof Error ? error.message : "\u7B14\u8BB0\u6392\u7248\u5907\u4EFD\u6062\u590D\u5931\u8D25");
        }
      }
    });
  ...
  async activateView() {
    ...
    if (rightLeaf) {
      ...
      new import_obsidian15.Notice("\u65E0\u6CD5\u521B\u5EFA\u89C6\u56FE\u9762\u677F");
    }
  }
};
